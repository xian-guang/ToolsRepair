...
public class WaterSparItem extends TestModElements.ModElement {
	@ObjectHolder("test:water_spar")
	public static final Item block = null;
	public WaterSparItem(TestModElements instance) {
		super(instance, 2);
	}
