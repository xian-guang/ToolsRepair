...
public class WaterBlockBlock extends TestModElements.ModElement {
	@ObjectHolder("test:water_block")
	public static final Block block = null;
	public WaterBlockBlock(TestModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(10f, 10f).lightValue(0).harvestLevel(2)
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("water_block", "water_block", blockAt -> {
			...
			}), block.getDefaultState(), 4)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(8, 30, 30, 64))));
		}
	}
}
